...
Var_contrast_boot_2D <- function(W, Psi_inv, beta, contrast, our_dim_1, TE_train, TR_train, sigma_train, train, TE_test, TR_test, sigma_test, test, train_scale, TE_scale, TR_scale, black_list, B = 15L, EM_iter = 10L, abs_diff = 1e-1, rel_diff = 1e-4, penalized = 1L) {
    .Call(`_symR_Var_contrast_boot_2D`, W, Psi_inv, beta, contrast, our_dim_1, TE_train, TR_train, sigma_train, train, TE_test, TR_test, sigma_test, test, train_scale, TE_scale, TR_scale, black_list, B, EM_iter, abs_diff, rel_diff, penalized)
}

Var_contrast_boot_3D <- function(W, Psi_inv, beta, contrast, our_dim_1, TE_train, TR_train, sigma_train, train, TE_test, TR_test, sigma_test, test, train_scale, TE_scale, TR_scale, black_list, B = 15L, EM_iter = 10L, abs_diff = 1e-1, rel_diff = 1e-4, penalized = 1L) {
