...
Matrix sizes: nx3, 3x3, 3(2)x1, mx1, mx1, mx1, nxm, ...
*/
double Q_OSL_per_voxel(const Matrix_eig &W, const Matrix3d_eig &Psi_inv, const Vector_eig &beta, 
                       const Vector_eig &TE, const Vector_eig &TR, const Vector_eig &sigma, 
                       const Matrix_eig &r, const Matrix_eig &W_old, const Vector_eig &c_i,
...
*/
Vector_eig Q_OSL_grad_per_voxel(const Matrix_eig &W, const Matrix3d_eig &Psi_inv, const Vector_eig &beta, 
                                const Vector_eig &TE, const Vector_eig &TR, const Vector_eig &sigma, 
                                const Matrix_eig &r, const Matrix_eig &W_old, const Vector_eig &c_i,
                                int n_x, int n_y, int n_z, int i){
