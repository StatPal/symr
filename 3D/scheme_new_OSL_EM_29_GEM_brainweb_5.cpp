...
int main(int argc, char * argv[]) {
	...
	file_orig.open ("result/W_orig_29_brainweb_5.0.txt");
...
//	}
	...
	file_LS.open ("result/W_LS_29_brainweb_5.0.txt");
	...
	file_OSL.open ("result/W_OSL_29_brainweb_5.0.txt");
	...
	file_AECM.open ("result/W_AECM_29_brainweb_5.0.txt");
