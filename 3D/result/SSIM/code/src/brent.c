/* $ID: brent.c, last updated 2018/07/23, F. Osorio */
...
{ /* Brent's method for unidimensional minimization.
   * This is a recoded version of fmin.f extracted from netlib.org which is a
   * slightly modified version of the 'localmin' procedure described in Brent,
   * R.P. (1973). Algorithms for Minimization Without Derivatives. Dover, New
   * York, pp. 79-80 and 188-190. */
    double a = ax, b = bx;
