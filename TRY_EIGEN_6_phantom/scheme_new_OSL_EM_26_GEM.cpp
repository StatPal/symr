...
int main(int argc, char * argv[]) {
	...
	file_performance.open ("result/Performances_26_new.txt");
	...
	file_LS.open ("result/W_LS_26_new.txt");
	for(int i = 0; i < W_init.rows(); ++i){
	...
	file_Likeli.open ("result/W_Likeli_26_new.txt");
	for(int i = 0; i < W_init.rows(); ++i){
		file_LS << W_init.row(i) << "\n";
	}
	file_Likeli.close();
	...
	*/
	...
	file_final.open ("result/W_final_26_new.txt");
	for(int i = 0; i < W_init.rows(); ++i){
