...
g++ scheme_new_OSL_EM_23_GEM.cpp -o test_23_2D -I /usr/include/eigen3 -O3 -lgsl -lgslcblas -lm




./test_23_2D ../Read_Data/new_phantom.nii Dummy_sd.txt 0

./test_23_2D ../Read_Data/small_phantom.nii Dummy_sd.txt 0

nohup ./test_23_2D ../Read_Data/new_phantom.nii Dummy_sd.txt 0 > test_23_2D.out & 
...
int main(int argc, char * argv[]) {
	...
	file_performance.open ("result/Performances_23.txt");
	...
	file_LS.open ("result/W_LS_23.txt");
	for(int i = 0; i < W_init.rows(); ++i){
	...
	file_Likeli.open ("result/W_Likeli_23.txt");
	for(int i = 0; i < W_init.rows(); ++i){
		file_LS << W_init.row(i) << "\n";
	}
	file_Likeli.close();
	...
	file_final.open ("result/W_final_23.txt");
	for(int i = 0; i < W_init.rows(); ++i){
