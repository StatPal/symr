...
// Var_contrast
Eigen::MatrixXd Var_contrast(const Eigen::MatrixXd W, const Eigen::MatrixXd Psi_inv, const Eigen::VectorXd beta, const Eigen::MappedSparseMatrix<double> contrast, const Eigen::Map<Eigen::VectorXd> our_dim_1, const Eigen::Map<Eigen::VectorXd>& TE_train, const Eigen::Map<Eigen::VectorXd>& TR_train, const Eigen::Map<Eigen::VectorXd>& sigma_train, const Eigen::Map<Eigen::MatrixXd>& train, const Eigen::Map<Eigen::VectorXd>& TE_test, const Eigen::Map<Eigen::VectorXd>& TR_test, const Eigen::Map<Eigen::VectorXd>& sigma_test, const Eigen::Map<Eigen::MatrixXd>& test, double train_scale, double TE_scale, double TR_scale, const Eigen::Map<Eigen::VectorXd>& black_list, int cg_maxiter, double cg_tol, int penalized, double abs_diff, double rel_diff, int verbose, int verbose2);
RcppExport SEXP _symR_Var_contrast(SEXP WSEXP, SEXP Psi_invSEXP, SEXP betaSEXP, SEXP contrastSEXP, SEXP our_dim_1SEXP, SEXP TE_trainSEXP, SEXP TR_trainSEXP, SEXP sigma_trainSEXP, SEXP trainSEXP, SEXP TE_testSEXP, SEXP TR_testSEXP, SEXP sigma_testSEXP, SEXP testSEXP, SEXP train_scaleSEXP, SEXP TE_scaleSEXP, SEXP TR_scaleSEXP, SEXP black_listSEXP, SEXP cg_maxiterSEXP, SEXP cg_tolSEXP, SEXP penalizedSEXP, SEXP abs_diffSEXP, SEXP rel_diffSEXP, SEXP verboseSEXP, SEXP verbose2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< int >::type verbose2(verbose2SEXP);
    rcpp_result_gen = Rcpp::wrap(Var_contrast(W, Psi_inv, beta, contrast, our_dim_1, TE_train, TR_train, sigma_train, train, TE_test, TR_test, sigma_test, test, train_scale, TE_scale, TR_scale, black_list, cg_maxiter, cg_tol, penalized, abs_diff, rel_diff, verbose, verbose2));
    return rcpp_result_gen;
END_RCPP
}
// Var_contrast_boot_2D
Eigen::MatrixXd Var_contrast_boot_2D(const Eigen::MatrixXd W, const Eigen::MatrixXd Psi_inv, const Eigen::VectorXd beta, const Eigen::MappedSparseMatrix<double> contrast, const Eigen::Map<Eigen::VectorXd> our_dim_1, const Eigen::Map<Eigen::VectorXd>& TE_train, const Eigen::Map<Eigen::VectorXd>& TR_train, const Eigen::Map<Eigen::VectorXd>& sigma_train, const Eigen::Map<Eigen::MatrixXd>& train, const Eigen::Map<Eigen::VectorXd>& TE_test, const Eigen::Map<Eigen::VectorXd>& TR_test, const Eigen::Map<Eigen::VectorXd>& sigma_test, const Eigen::Map<Eigen::MatrixXd>& test, double train_scale, double TE_scale, double TR_scale, const Eigen::Map<Eigen::VectorXd>& black_list, int B, int EM_iter, double abs_diff, double rel_diff, int penalized);
RcppExport SEXP _symR_Var_contrast_boot_2D(SEXP WSEXP, SEXP Psi_invSEXP, SEXP betaSEXP, SEXP contrastSEXP, SEXP our_dim_1SEXP, SEXP TE_trainSEXP, SEXP TR_trainSEXP, SEXP sigma_trainSEXP, SEXP trainSEXP, SEXP TE_testSEXP, SEXP TR_testSEXP, SEXP sigma_testSEXP, SEXP testSEXP, SEXP train_scaleSEXP, SEXP TE_scaleSEXP, SEXP TR_scaleSEXP, SEXP black_listSEXP, SEXP BSEXP, SEXP EM_iterSEXP, SEXP abs_diffSEXP, SEXP rel_diffSEXP, SEXP penalizedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd >::type W(WSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type rel_diff(rel_diffSEXP);
    Rcpp::traits::input_parameter< int >::type penalized(penalizedSEXP);
    rcpp_result_gen = Rcpp::wrap(Var_contrast_boot_2D(W, Psi_inv, beta, contrast, our_dim_1, TE_train, TR_train, sigma_train, train, TE_test, TR_test, sigma_test, test, train_scale, TE_scale, TR_scale, black_list, B, EM_iter, abs_diff, rel_diff, penalized));
    return rcpp_result_gen;
END_RCPP
}
// Var_contrast_boot_3D
Eigen::MatrixXd Var_contrast_boot_3D(const Eigen::MatrixXd W, const Eigen::MatrixXd Psi_inv, const Eigen::VectorXd beta, const Eigen::MappedSparseMatrix<double> contrast, const Eigen::Map<Eigen::VectorXd> our_dim_1, const Eigen::Map<Eigen::VectorXd>& TE_train, const Eigen::Map<Eigen::VectorXd>& TR_train, const Eigen::Map<Eigen::VectorXd>& sigma_train, const Eigen::Map<Eigen::MatrixXd>& train, const Eigen::Map<Eigen::VectorXd>& TE_test, const Eigen::Map<Eigen::VectorXd>& TR_test, const Eigen::Map<Eigen::VectorXd>& sigma_test, const Eigen::Map<Eigen::MatrixXd>& test, double train_scale, double TE_scale, double TR_scale, const Eigen::Map<Eigen::VectorXd>& black_list, int B, int EM_iter, double abs_diff, double rel_diff, int penalized);
RcppExport SEXP _symR_Var_contrast_boot_3D(SEXP WSEXP, SEXP Psi_invSEXP, SEXP betaSEXP, SEXP contrastSEXP, SEXP our_dim_1SEXP, SEXP TE_trainSEXP, SEXP TR_trainSEXP, SEXP sigma_trainSEXP, SEXP trainSEXP, SEXP TE_testSEXP, SEXP TR_testSEXP, SEXP sigma_testSEXP, SEXP testSEXP, SEXP train_scaleSEXP, SEXP TE_scaleSEXP, SEXP TR_scaleSEXP, SEXP black_listSEXP, SEXP BSEXP, SEXP EM_iterSEXP, SEXP abs_diffSEXP, SEXP rel_diffSEXP, SEXP penalizedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd >::type W(WSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type rel_diff(rel_diffSEXP);
    Rcpp::traits::input_parameter< int >::type penalized(penalizedSEXP);
    rcpp_result_gen = Rcpp::wrap(Var_contrast_boot_3D(W, Psi_inv, beta, contrast, our_dim_1, TE_train, TR_train, sigma_train, train, TE_test, TR_test, sigma_test, test, train_scale, TE_scale, TR_scale, black_list, B, EM_iter, abs_diff, rel_diff, penalized));
    return rcpp_result_gen;
END_RCPP
}
