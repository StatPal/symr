...
g++ All_possible_29_GEM.cpp -o all_29_2D -I /usr/include/eigen3 -O3 -lgsl -lgslcblas -lm -fopenmp




./all_29_2D ../Read_Data/new_phantom.nii Dummy_sd.txt 0

./all_29_2D ../data/new_phantom.nii Dummy_sd.txt 0

./all_29_2D ../Read_Data/small_phantom.nii Dummy_sd.txt 0

nohup ./all_29_2D ../Read_Data/new_phantom.nii Dummy_sd.txt 0 > all_29_2D.out & 
...
// Change
	...
	if(verbose){
		if(penalized){
			Debug1("Time taken for whole AECM: " << duration_45.count() << " microseconds\n");
		} else {
